...
equ	trap_S_RealRegisterSound			-35
equ	trap_S_StartBackgroundTrack			-36
equ	trap_R_LoadWorldMap				-37
equ	trap_R_RealRegisterModel				-38
equ	trap_R_RegisterSkin				-39
equ	trap_R_RegisterShader				-40
equ	trap_R_ClearScene				-41
equ	trap_R_RealAddRefEntityToScene		-42
equ	trap_R_RealAddPolyToScene				-43
equ	trap_R_RealAddLightToScene				-44
...
equ	trap_R_RealAddAdditiveLightToScene			-86
equ	trap_GetEntityToken				-87
equ trap_R_RealAddPolysToScene			-88
equ trap_R_inPVS					-89
