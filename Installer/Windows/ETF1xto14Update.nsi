...
;ETF windows installer 1.x -> 1.4 Update
;Slothy@etfgame.com
...
;General
  ...
  BrandingText /TRIMLEFT "ETF 1.x -> 1.4 Update"
...
;Pages
  ...
  !define MUI_WELCOMEPAGE_TITLE "Welcome to the ETF 1.4 Upgrade Installation Wizard"
...
;  File "etf_pak0.pk3"
  ...
  File "etf_pak4.pk3"			; added for 1.4
...
;  File "sample_server.cfg"
  ...
  File "14_changelog.txt"		; added for 1.4
  File "etf_dissect.pk3"
  Delete "ETFUpdater.exe"
  Delete "libcurl.dll"
  Delete "etf_spazball.pk3"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\etf_pak4.pk3"		; added for 1.4
  ...
  Delete "$INSTDIR\14_changelog.txt"		; added for 1.4
...
LangString DESC_ETFNotFound ${LANG_ENGLISH} \
    "Unable to locate ETF files.  This installation can update an existing ETF installation from 1.x to 1.4.$\r$\n$\r$\nIf you do not have ETF installed, you can download it from http://www.etfgame.com/"
