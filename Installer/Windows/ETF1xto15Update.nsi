...
;ETF windows installer 1.x -> 1.5 Update
;Slothy@etfgame.com
...
;General
  ...
  BrandingText /TRIMLEFT "ETF 1.x -> 1.5 Update"
...
;Pages
  ...
  !define MUI_WELCOMEPAGE_TITLE "Welcome to the ETF 1.5 Upgrade Installation Wizard"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\etf_pak4.pk3"		; added for 1.5
  ...
  Delete "$INSTDIR\15_changelog.txt"		; added for 1.5
...
LangString DESC_ETFNotFound ${LANG_ENGLISH} \
    "Unable to locate ETF files.  This installation can update an existing ETF installation from 1.x to 1.5.$\r$\n$\r$\nIf you do not have ETF installed, you can download it from http://www.etfgame.com/"
