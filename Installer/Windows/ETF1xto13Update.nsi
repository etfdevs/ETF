...
;ETF windows installer 1.x -> 1.3 Update
;Slothy@etfgame.com
...
;General
  ...
  BrandingText /TRIMLEFT "ETF 1.x -> 1.3 Update"
...
;Pages
  ...
  !define MUI_WELCOMEPAGE_TITLE "Welcome to the ETF 1.3 Upgrade Installation Wizard"
...
LangString DESC_ETFNotFound ${LANG_ENGLISH} \
    "Unable to locate ETF files.  This installation can update an existing ETF installation from 1.x to 1.3.$\r$\n$\r$\nIf you do not have ETF installed, you can download it from http://www.etfgame.com/"
...
Function ETFDirValidate
  ...
  ; check for ETF
    IfFileExists "$INSTDIR\etf\etf_pak0.pk3" ETF12True ETF12False
  ETF12False:
