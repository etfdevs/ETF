		...
		if (GIT_RESULT EQUAL 0)
			...
			if (GIT_BRANCH_RESULT EQUAL 0)
				...
				execute_process(
					...
					WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
					RESULT_VARIABLE GIT_SHORTHASH_RESULT
					OUTPUT_VARIABLE GIT_SHORTHASH
					OUTPUT_STRIP_TRAILING_WHITESPACE
					ERROR_QUIET
				)
				if (GIT_SHORTHASH_RESULT EQUAL 0)
					set("${VAR}_COMMIT_HASH_SHORT" "${GIT_SHORTHASH}")
				endif()
			endif()
			set("${VAR}" "${CMAKE_PROJECT_VERSION}-${GIT_SHORTHASH}")
			set("${VAR}_COMMIT" "0")
