...
function(get_platform_suffix var_name var_arch)
	if(WIN32)
		set(LIB_SUFFIX "_mp_")
	elseif(APPLE)
		set(LIB_SUFFIX "_mac")
	...
	set(${var_arch} "${LIB_ARCH}" PARENT_SCOPE)
endfunction()

function(set_target_platform_details target)
	get_platform_suffix(PLATFORM_SUFFIX PLATFORM_ARCH)
	message(${target}${PLATFORM_SUFFIX})
	...
	target_compile_definitions(${target} PRIVATE ARCH_STRING="${PLATFORM_ARCH}")
	if (APPLE)
