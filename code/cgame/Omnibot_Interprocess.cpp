...
extern "C" void ClearDebugDraw(void);
extern "C" void CG_DrawLine(float *start, float *end, int color);

class ETFClientInterface : public IClientInterface
{
...
extern "C" void OmnibotDrawActiveFrame()
{
	...
	#define OMNIBOT_API __global
#elif ((__GNUC__ >= 3) && (!__EMX__) && (!sun))
	#define OMNIBOT_API __attribute__((visibility("default")))
#else
	#define OMNIBOT_API
#endif
