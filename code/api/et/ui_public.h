...
typedef enum {
	...
	UIMENU_TEAM,
	UIMENU_POSTGAME,
	UIMENU_CUSTOM,		// Arnout: Q3F Port: inserted
	UIMENU_ENDGAME,		// Arnout: Q3F Port: inserted
	UIMENU_HELP,
...
#define SORT_PING			3
#define SORT_FILTERS		4
#define SORT_FAVOURITES		5
#define SORT_PURE			6
#define SORT_PASSWORDED		7
#define SORT_NUMBOTS		8
#define SORT_PUNKBUSTER		9
#define SORT_VERSION		10
