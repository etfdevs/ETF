...
// Arnout - Q3F Port: renamed it back from SVF_BLANK as code still references it. (it still doesn't do anything though)
#define	SVF_USE_CURRENT_ORIGIN	0x00000080	// Gordon: removed SVF_USE_CURRENT_ORIGIN as it plain doesnt do anything
