...
#pragma warning(disable : 4706)		// assignment
...
float AngleNormalize2Pi ( float angle ); // RR2DO2
...
void RotatePointAroundVertex ( vec3_t pnt, float rot_x, float rot_y, float rot_z, const vec3_t origin ); // RR2DO2
...
#define BUTTON_WAVENO		32
#define	BUTTON_WAVEYES		64
#define BUTTON_LOOK			128
#define BUTTON_BECON		256
#define BUTTON_STOP			512
#define BUTTON_POINT		1024
...
#define GLYPH_CHARSTART2		160
#define GLYPH_CHAREND2			255
#define GLYPHS_PER_FONT			GLYPH_END - GLYPH_START + 1
#define MAX_SHADERS_PER_FONT	3
